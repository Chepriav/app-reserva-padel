export const colors = {
  primary: '#1a365d',      // Azul marino oscuro - color principal
  secondary: '#2c5282',    // Azul marino medio - secundario
  accent: '#d69e2e',       // Dorado - acentos y destacados
  background: '#f7fafc',   // Gris azulado muy claro
  surface: '#ffffff',      // Blanco
  error: '#c53030',        // Rojo elegante
  text: '#1a202c',         // Casi negro azulado
  textSecondary: '#718096', // Gris azulado
  disabled: '#a0aec0',     // Gris medio
  border: '#e2e8f0',       // Gris claro azulado
  success: '#2f855a',      // Verde para confirmaciones
  gold: '#d69e2e',         // Dorado para badges premium
  goldLight: '#ecc94b',    // Dorado claro
  // Colores para sistema de prioridad de reservas
  reservaGarantizada: '#2f855a',  // Verde - reserva primera/garantizada
