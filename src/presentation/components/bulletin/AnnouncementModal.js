...
function formatDateCompleta(dateStr) {
...
export function AnnouncementModal({ announcement, visible, onClose, isAdmin, onDelete }) {
          ...
          <View style={[styles.header, { backgroundColor: `${config.color}10` }]}>
            ...
            <View style={styles.meta}>
              <View style={styles.metaItem}>
                ...
                <Text style={styles.metaText}>{announcement.creatorName}</Text>
              </View>
              <View style={styles.metaItem}>
                <Ionicons name="time-outline" size={14} color={colors.textSecondary} />
                <Text style={styles.metaText}>
                  {formatDateCompleta(announcement.createdAt)}
                </Text>
              </View>
            </View>
          </View>
