...
export const styles = StyleSheet.create({
  ...
  typeButton: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: colors.border, gap: 6 },
  typeLabel: { fontSize: 13, color: colors.textSecondary },
  recipientsOptions: { gap: 8 },
