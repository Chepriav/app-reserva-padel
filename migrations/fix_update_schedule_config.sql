-- Corrección de la función update_schedule_config
-- El problema anterior: COALESCE no permite limpiar valores NULL
-- Esta versión actualiza TODOS los campos siempre
